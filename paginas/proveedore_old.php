...
switch($accion){
	...
	case 'listado':
		...
		$sql="SELECT * FROM proveedor LIMIT $inicioLimite,$numeroDeRegistrosPorPagina";
	...
	if($_SESSION['conectado']){
		if(isset($_POST['enviar'])){
			...
			$sql="UPDATE proveedor SET nombreProveedor='$nombreProveedor', telefonoProveedor='$telefonoProveedor' WHERE idProveedor='$idProveedor'";
	...
	if($_SESSION['conectado']){
		if(isset($_POST['enviar'])){
			...
			$sql="INSERT INTO proveedor (nombreProveedor, telefonoProveedor) VALUES ('$nombreProveedor','$telefonoProveedor')";
